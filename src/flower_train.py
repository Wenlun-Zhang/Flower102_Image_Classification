...
The main training code for <102 Category Flower Dataset>.
...
# setup_seed(6666)    # Set random seed for repeatable experiment
...
if __name__ == '__main__':      # Main script for model training
    ...
    # Step 2: Model
    model = load_model(cfg, train_data.class_num, logger)
